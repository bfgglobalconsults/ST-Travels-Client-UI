...
import BangkokHighlight from "./BangkokHighlight";

const BangkokTabContentComponent: FC<ITabContentComponentProps> = ({ data }) => {
  ...
  return (
    <div className={"menu-top menu-up"} id="searchBar">
      ...
      >
        ...
        <TabPane tabId="2">
          <Gallery galleryData={bangkokGalleryData} />
        </TabPane>
        {/* <TabPane tabId="4">
...
export default BangkokTabContentComponent;
