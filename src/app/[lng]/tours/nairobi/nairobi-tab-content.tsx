...
import NairobiHighlight from "./NairobiHighlight";
// import DubaiHighlight from "./DubaiHighlight";
// import TurkeyHighlight from "./TurkeyHighlight";

const NairobiTabContentComponent: FC<ITabContentComponentProps> = ({ data }) => {
  ...
  return (
    <div className={"menu-top menu-up"} id="searchBar">
      ...
      >
        ...
        <TabPane tabId="2">
          <Gallery galleryData={nairobiGalleryData} />
        </TabPane>
        {/* <TabPane tabId="4">
...
export default NairobiTabContentComponent;
