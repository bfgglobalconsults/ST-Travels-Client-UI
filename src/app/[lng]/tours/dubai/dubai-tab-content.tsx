...
import { dubaiGalleryData, galleryData } from "@/data/tour/single-page";
import Gallery from "@/components/tour/single-page/common/sections/gallery";
import DubaiHighlight from "./DubaiHighlight";

const DubaiTabContentComponent: FC<ITabContentComponentProps> = ({ data }) => {
  ...
  return (
    <div className={"menu-top menu-up"} id="searchBar">
      ...
      >
        ...
        <TabPane tabId="2">
          <Gallery galleryData={dubaiGalleryData} />
        </TabPane>
        {/* <TabPane tabId="4">
...
export default DubaiTabContentComponent;
